...
hoy = date.today()
file_path = r'C:\Users\JFROJAS\Desktop\ValijaMDSTK\Archivos\Calidad de la orden (2).csv'

df = pd.read_csv(file_path)
df = df.iloc[:, [1, 2, 20, 24, 23, 33, 32]]

formato_path = r'C:\Users\JFROJAS\Desktop\ValijaMDSTK\Archivos\SGC-000614 Relación de Acuses de Recibo Enviados.xlsx'
